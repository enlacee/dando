...
CREATE TABLE `publicaciones_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=latin1 COMMENT='ok';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-05-21 19:00:02
