                    ...
                    <div class="span9">
                        ...
                        <form class="form-horizontal" id="form" name="form" method="post" action="">
                            ...
                            <div class="registerbox">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="email" type="text" autocomplete="" class="input-xlarge" id="email" placeholder="Ingrese su email">
                            ...
                            <div class="form-actions">
                                ...
                                <div class="label label-warning" id="validarEmail"></div>
                            </div>
                            ...
                            submitHandler: function(form) {                                
                                ...
                                $.ajax({
                                     ...
                                     success : function(respuesta) {
                                        if (respuesta == "0") {
                                            $("#mensaje").html("<img src='images/iconos/si.png' alt='loading' />");
                                            form.submit();
                                        }else if (respuesta == "1"){
                                            $("#mensaje").html("<img src='images/iconos/no.png' alt='loading' />");
                                            $("#validarEmail").html("Corregir correo ya se encuentra registrado: "+$("#email").val());
                                        }					
                                     },
                                 });                                
