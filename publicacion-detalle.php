...
<?php
for($i=0;$i<sizeof($publicacion_detalle);$i++){
?>
      <div class="span9">
            <div class="row">
                <!-- Left Image-->
                <div class="span4">
					<?php /*?><img src="images/productos/<?php echo $publicacion_detalle[0]["foto"]; ?>"><?php */?>
                                        <!-- template -->
                    <div class="ms-showcase2-template ms-showcase2-vertical">
                                ...
                                <div class="milindex-slider ms-skin-default" id="milindexslider">
                                	<?php for($i=1;$i<=6;$i++){ ?>
                                    <div class="ms-slide">
                                        <img src="milindexslider/blank.gif" data-src="images/productos/<?php echo $publicacion_detalle[0]["foto"]; ?>" alt="lorem ipsum dolor sit"/> 
                                        <img class="ms-thumb" src="images/productos/<?php echo $publicacion_detalle[0]["foto"]; ?>" alt="thumb" />
                                    </div>
                                    <?php } ?>
                                </div>
